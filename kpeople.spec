...
Source0  : https://download.kde.org/stable/frameworks/6.1/kpeople-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kpeople-6.1.0.tar.xz.sig
...
%setup -q -n kpeople-6.1.0
cd %{_builddir}/kpeople-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712966582
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6People.so.6.1.0
/V3/usr/lib64/libKF6PeopleBackend.so.6.1.0
/V3/usr/lib64/libKF6PeopleWidgets.so.6.1.0
...
/usr/lib64/libKF6People.so.6.1.0
/usr/lib64/libKF6PeopleBackend.so.6
/usr/lib64/libKF6PeopleBackend.so.6.1.0
/usr/lib64/libKF6PeopleWidgets.so.6
/usr/lib64/libKF6PeopleWidgets.so.6.1.0
