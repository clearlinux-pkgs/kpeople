...
Source0  : https://download.kde.org/stable/frameworks/5.112/kpeople-5.112.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.112/kpeople-5.112.0.tar.xz.sig
...
%prep
%setup -q -n kpeople-5.112.0
cd %{_builddir}/kpeople-5.112.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699904666
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5People.so.5.112.0
/V3/usr/lib64/libKF5PeopleBackend.so.5.112.0
/V3/usr/lib64/libKF5PeopleWidgets.so.5.112.0
/V3/usr/lib64/qt5/qml/org/kde/people/libKF5PeopleDeclarative.so
/usr/lib64/libKF5People.so.5
/usr/lib64/libKF5People.so.5.112.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.112.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.112.0
