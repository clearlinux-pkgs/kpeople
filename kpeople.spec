...
Source0  : https://download.kde.org/stable/frameworks/5.76/kpeople-5.76.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.76/kpeople-5.76.0.tar.xz.sig
...
%prep
%setup -q -n kpeople-5.76.0
cd %{_builddir}/kpeople-5.76.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605428077
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpeople-5.76.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kpeople/6f1f675aa5f6a2bbaa573b8343044b166be28399
pushd clr-build
%make_install
popd
%find_lang kpeople5
...
/usr/lib64/libKF5People.so.5.76.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.76.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.76.0
