...
Source0  : https://download.kde.org/stable/frameworks/5.64/kpeople-5.64.0.tar.xz
Source1 : https://download.kde.org/stable/frameworks/5.64/kpeople-5.64.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573423972
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpeople-5.64.0/COPYING %{buildroot}/usr/share/package-licenses/kpeople/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
%find_lang kpeople5
...
/usr/lib64/libKF5People.so.5.64.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.64.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.64.0
