...
Version  : 5.109.0
Release  : 64
URL      : https://download.kde.org/stable/frameworks/5.109/kpeople-5.109.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.109/kpeople-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/kpeople-5.109.0.tar.xz.sig
...
%prep
%setup -q -n kpeople-5.109.0
cd %{_builddir}/kpeople-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693072604
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5People.so.5.109.0
/V3/usr/lib64/libKF5PeopleBackend.so.5.109.0
/V3/usr/lib64/libKF5PeopleWidgets.so.5.109.0
/V3/usr/lib64/qt5/qml/org/kde/people/libKF5PeopleDeclarative.so
/usr/lib64/libKF5People.so.5
/usr/lib64/libKF5People.so.5.109.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.109.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.109.0
