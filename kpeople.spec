...
Source0  : https://download.kde.org/stable/frameworks/5.100/kpeople-5.100.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.100/kpeople-5.100.0.tar.xz.sig
...
%prep
%setup -q -n kpeople-5.100.0
cd %{_builddir}/kpeople-5.100.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668447222
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5People.so.5.100.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.100.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.100.0
