...
Source0  : https://download.kde.org/stable/frameworks/5.93/kpeople-5.93.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.93/kpeople-5.93.0.tar.xz.sig
...
%prep
%setup -q -n kpeople-5.93.0
cd %{_builddir}/kpeople-5.93.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649704346
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kpeople-5.93.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kpeople/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kpeople-5.93.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kpeople/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kpeople-5.93.0/README.md.license %{buildroot}/usr/share/package-licenses/kpeople/37d1ccdb1e19e25429b2c910ddfef5c7242f7b62
pushd clr-build
%make_install
popd
%find_lang kpeople5
...
/usr/lib64/libKF5People.so.5.93.0
/usr/lib64/libKF5PeopleBackend.so.5
/usr/lib64/libKF5PeopleBackend.so.5.93.0
/usr/lib64/libKF5PeopleWidgets.so.5
/usr/lib64/libKF5PeopleWidgets.so.5.93.0
